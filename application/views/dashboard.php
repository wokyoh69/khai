    ...
    <section class="content">
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-aqua">
            <div class="inner">
              <font size="5"><b><?php echo number_format($total_payment, 2); ?></b></font>
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-red">
            <div class="inner">
              <font size="5"><b><?php echo number_format($total_tunggakan, 2); ?></b></font>
        ...
        <div class="col-lg-3 col-xs-6">
          <div class="small-box bg-green">
            <div class="inner">
              <font size="5"><b><?php echo number_format($total_perbelanjaan, 2); ?></b></font>
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-yellow">
            <div class="inner">
              <font size="5"><b><?php echo number_format($currentbalance, 2); ?></b></font>
    ...
    <section class="content">
      ...
      <div class="row">
        ...
        <div class="col-lg-6 col-xs-6">
          ...
          <div class="small-box bg-red">
            <div class="inner">
              <h3><?php echo number_format($total_tunggakan, 2); ?></h3>
            ...
            <div class="box-body">
              ...
              <table class="table table-striped table-hover" style="margin-bottom: 10px">
                                  ...
                                  <td width="400"> 
                                    ...
                                    <td align="right">
                                      ...
                                      if ($pr->status == "Belum Selesai") { ?>
                                        <!--<button type="submit" name="fpx" class="btn btn-sm btn-danger" value="<?php echo $pr->total_amaun; ?>">Bayar </button>-->
                ...
                <div class="row">
                  ...
                  <div align="center">
                    <button type="submit" name="submit" class="btn btn-md btn-danger" value="Submit">Bayar Sekarang</button><br>&nbsp;</br>
                    <img src="<?php echo base_url(); ?>assets/images/toyyibpay_button.png" width="250" class="img-fluid"><br>&nbsp;<br>
                     <input type="hidden" name="userid" value="<?php echo $userid; ?>" /> 
                ...
                <form role="form" action="<?php echo base_url() ?>loadWarning" method="post" id="loadWarning" role="form">
                    <!--amaran -->
                   <?php if($unpaidcount >= $tunggakan) { ?>
                    <a class="btn btn-warning" href="<?php echo base_url().'loadWarning'; ?>">Surat Peringatan </a>
                    <br><font color="red">Nota : Surat Peringatan akan dijana jika terdapat yuran berstatus <b>BELUM SELESAI</b> </font>
                   <?php } ?>
                   <!-- amaran end --> 
            ...
            <div class="box-body">
              <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                  <div class="item active" bgcolor="bg-red">
                    <center>
                    <img src="<?php echo base_url(); ?>assets/images/tq-ek.png" width="70%" alt="First slide">

                    <br>

                      <h3 class="text-uppercase">Aplikasi Pintar Belajar Al-Quran</h3>
                      <p>e-Khairat menyokong ke arah memperkasakan ummah dengan memahami Al-Quran dengan kaedah yang mudah melalui aplikasi pintar Think Quran.</p>
                      <a href="https://app.thinkquran.com?r=ekhairat&act=ob" class="btn btn-primary text-uppercase">BELAJAR SEKARANG !</a>
                  ...
                  <div class="item">
                    <center>
                    <img src="<?php echo base_url(); ?>assets/images/tq-ek2.png" width="70%" alt="First slide">

                    <br>

                      <h3 class="text-uppercase">Mudah, Menarik, dan Efektif</h3>
                      <p>Belajar 5 minit sehari, tanpa asas bahasa Arab dan sesuai semua peringkat umur. <br>Selamat Mencuba !</p>
                      <a href="https://app.thinkquran.com?r=ekhairat&act=ob" class="btn btn-primary text-uppercase">BELAJAR SEKARANG !</a>
