    ...
    <div class="col-md-6">
        <div class="card card-success">
          <div class="card-header">
            <h3 class="card-title"><i class="icofont-ui-password"></i>&nbsp;LUPA KATA LALUAN</h3>
          </div>
          <!-- /.card-header -->
          <!-- form start -->
          <?php $this->load->helper("form"); ?>
            ...
            <form action="<?php echo base_url(); ?>forgetMe" method="post" name="formcheck">
            <div class="row">
              <div class="col-sm-12">
                <div class="form-group">
                  ...
                  <div class="input-group input-group-xl">
                    <input type="text" class="form-control" placeholder="Sila Masukkan No. Kad Pengenalan " name="icno" value="" maxlength="12" required>
                    <span class="input-group-append">
                      <button id="submit" type="submit" class="btn btn-success"><i class="icofont-send-mail"></i> RESET</button>
                    </span>
                   </div>
          ...
          <div class="row" align="center">
            <div class="col-sm-12">         
                ...
                <font size="5"><strong>MAKLUMAN</strong></font><br>
                Kata laluan baru akan dihantar ke emel yang telah didaftarkan. Sebarang permasalahan
                sila ajukan ke emel <a href="mailto:<?php echo $g_email; ?>"><?php echo $g_email; ?></a> atau 
                <a href="http://www.wasap.my/+6<?php echo $g_phone; ?>/eKhairat:">Whatsapp</a>
                <p>&nbsp;
            </div>
          </div>
