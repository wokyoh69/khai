...
$message = "Masukkan mesej SMS";

$sms = strtoupper($g_home_title)." : Masukkan mesej yang ingin dihantar ..";
//$sms = "Masukkan mesej SMS";
$sms = str_replace("@","-",$sms);
            ...
            <div class="row"><!-- row 2-->
                ...
                <div class="col-md-12"> 
                	<div class="form-group">
                        ...
                        <input class="form-control"  type="text" name="phone" id="phone" value="" pattern="[0-9]{10,11}" maxlength="11" placeholder="No. Telefon (cth:0129000123)" required>
                    </div>                                
                    <div class="form-group">
                    	<label>Mesej:</label>
