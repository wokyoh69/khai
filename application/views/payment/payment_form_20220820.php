              ...
              <div class="box-body table-responsive"> <!-- start table A -->
                <table class="table table-bordered table-striped table-hover" style="margin-bottom: 10px">
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="<?= base_url().'payment/deletePaymentDetail/'.$p_id.'/'.$det_a->pf_id; ?>" onclick="javasciprt: return confirm('Delete ?')"><span class="badge bg-red"><i class="fa fa-trash"></i></span></a>
                  ...
                  { 
                    ...
                    <tr>
                      ...
                      <td>
                        <a href="<?= base_url().'payment/deletePaymentDetail/'.$p_id.'/'.$det->pf_id; ?>" onclick="javasciprt: return confirm('Delete ?')"><span class="badge bg-red"><i class="fa fa-trash"></i></span></a>
            ...
            <div class="col-md-8"> 
              <div class="form-group">
                  ...
                  <?php if((!empty($attachment)) AND ($attachment != "default.jpg")) { ?>
                    ...
                    <a href="<?= site_url().'upload/'.$attachment; ?>" target="_blank"> <span class="badge bg-blue"><i class="fa fa-paperclip"></i></span> view attachment : "<?php echo $attachment; ?>"</a>
