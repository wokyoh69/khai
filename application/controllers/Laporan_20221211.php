...
public function umur ($noic) {
    ...
    foreach ($this->user_model->export_Ahli() as $ahli) {
        ...
        //xlsWriteLabel($tablebody, $kolombody++, $this->umur($ahli->icno));
        ...
        foreach ($this->user_model->export_Tanggungan($ahli->userId) as $family) 
                {
                    ...
                    //echo "<br>";
                    $tablebody++;
                    xlsWriteLabel($tablebody, 7, $family->f_name);
                    xlsWriteLabel($tablebody, 8, $family->f_icno);
                    xlsWriteLabel($tablebody, 9, $family->f_pertalian);
